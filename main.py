...
with HandLandmarker.create_from_options(options) as landmarker:
    ...
    target_label = alphabets[current_letter_index]
    ...
    while True:
        ...
        if is_recording == False:
            ...
            text = "Current Letter: " + str(target_label)
            position = (30, 80)
        ...
        if key == ord('q'):
            ...
            is_recording = True
            saved_frame_count = 0
        elif key == ord('n') and current_letter_index < len(alphabets) - 1:
            if current_letter_index < len(alphabets):
